...
import GlobalContext from "../../calendari/context/GlobalContext";
...
const guardarEstado=()=>{
    api.post(url1,{body: {id:idState, estado:estado},headers:
        {"Content-Type":"application/json",
            "x-access-token":stateLogin.login.user.token,
            "Accept":"*",
            "Accept-Encoding":"gzip, deflate, br"
...
setIdState(id)
        ...
        let colaborador=document.querySelector(getId)
         ...
         colaborador.style.aling="center"
        setTimeout(()=>{colaborador.style.display='none';},50000)
    }
    const columns=[
        {
            name:'Nombre',
        ...
        {
            name:'Acción',
            cell:row=><><div className='empleado' id={'colaborador'+row.id}>
                            {/* <div onClick={()=>{handleClickEdit(row.id)}} >
                             Editar
                            </div> */}
                        </div>
                        <img className='puntos' onClick={()=>{handleClickPuntos(row.id)}} src={puntos}/></>,
            sortable:true,
                      ...
                      <DataTable
                        ...
                        {modal && (
                            ...
                            <div className="modal-content">
                                {
                                    exito?<>
                                    <h2>actualizado con exito</h2>
                                    <button onClick={()=>(setModal(false),setExito(false))}>Cerrar</button>
                                    </>:<>
                                    <h2>seleccione una opcion para actualizar</h2>
                              ...
                              <button onClick={()=>guardarEstado()}>Actializar</button>
                              </div>
                                    </>
                                }
                            </div>
